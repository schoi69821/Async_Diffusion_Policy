...
def main():
    ...
    try:
        while not stop.is_set():
            ...
            # Gripper control: position-based grasp zone trigger.
            # Let diffusion model drive gripper naturally; override only on zone entry/exit.
